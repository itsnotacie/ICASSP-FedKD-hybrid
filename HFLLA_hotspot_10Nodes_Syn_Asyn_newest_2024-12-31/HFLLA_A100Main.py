...
from HFLLA  import  HFLLA

def parseArg():
    parser = argparse.ArgumentParser(description='HFLLA, a federated learning framework. \
    Participants are training collaboratively. ')  # HFLLA，一个联邦学习框架。参与者正在合作培训。
    parser.add_argument('-conf', metavar='conf_file', nargs=1,
                        help='the config file for HFLLA.'
...
if __name__ == "__main__":
    ...
    for asynchronousRate in asynchronousRates:
        ...
        initialization_result = HFLLA.init_result
        pooled_train_result = HFLLA.pooled_train_result

        collaboration_performance = HFLLA.collaborative_training()
